...
PRD → 페르소나 → 유저스토리 → 인터뷰 질문 → 가상 인터뷰(2-에이전트, 1회) → 불편사항 검증 → **사람에게 물을 질문** → (답변 받은 뒤) v2 PRD.
...
| 11-open-questions.md | 사람에게 물을 질문 목록 | 제품 소개서, 기능 목록, 다뤄지지 않은 기능, 페르소나, 검증 통과 불편사항, 인터뷰 전사, 저장 경로 |
| 10-prd-v2.md | (2단계) PRD v2 개정 | PRD 경로, 페르소나 파일, 제품 설명서 파일, 불편사항 파일, 질문 파일, 답변, 저장 경로 |
